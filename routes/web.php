...
//Admin Routes
Route::get('administrator', '\App\Modules\Auth\Controllers\AdminController@getLogin');
Route::post('administrator', '\App\Modules\Auth\Controllers\AdminController@postLogin');
//Admin Routes
